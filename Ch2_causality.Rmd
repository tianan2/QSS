...
minwage %>% filter(location == "NJ") %>% 
  summarize(prop_before_after = mean(fullAfter / (fullAfter + partAfter)) - mean(fullBefore / (fullBefore + partBefore)))

# Difference in Differences design
minwage %>% 
  group_by(location) %>% 
  summarize(prop_before = mean(fullBefore / (fullBefore + partBefore)), 
            prop_after = mean(fullAfter / (fullAfter + partAfter))) %>% 
